...
const QuestionPage1 = props => {
  const {history} = props
  const OnClickQuestionPage1 = () => {
    history.replace('/QuestionPage2')
  }
  return (
          ...
          <div className="circle-border">
            <div className="circle">
              <h1 className="QuestionPage1Heading">
                1<span className="SpanQuestionPage1Heading">/5</span>
              </h1>
            </div>
          </div>
        </div>
