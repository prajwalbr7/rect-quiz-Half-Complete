...
const QuestionPage4 = props => {
  const {history} = props
  const OnClickQuestionPage4 = () => {
    history.replace('/QuestionPage5')
  }
  return (
          ...
          <div className="circle-border">
            <div className="circle">
              <h1 className="QuestionPage1Heading">
                4<span className="SpanQuestionPage1Heading">/5</span>
              </h1>
            </div>
          </div>
        </div>
