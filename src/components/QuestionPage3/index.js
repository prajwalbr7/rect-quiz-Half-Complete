...
const QuestionPage3 = props => {
  const {history} = props
  const OnClickQuestionPage3 = () => {
    history.replace('/QuestionPage4')
  }
  return (
          ...
          <div className="circle-border">
            <div className="circle">
              <h1 className="QuestionPage1Heading">
                3<span className="SpanQuestionPage1Heading">/5</span>
              </h1>
            </div>
          </div>
        </div>
